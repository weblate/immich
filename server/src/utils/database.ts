...
export const withTimeBucket = (eb: ExpressionBuilder<DB, 'assets'>, size: TimeBucketSize) =>
  eb.fn('date_trunc', [sql`${truncateMap[size]}`, sql`assets."localDateTime" at time zone 'UTC'`]);
